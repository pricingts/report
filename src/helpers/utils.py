...
STATUS_MAP = {
    ...
    "DE": {"es": "CONTENEDOR VACIO NO RETORNADO", "en": "EMPTY CONTAINER NOT RETURNED"},
    "A": {"es": "CARGA PROXIMA A ARRIBAR", "en": "CARGO ARRIVING SOON"},
    "D": {"es": "CARGA EN DESTINO", "en": "LOAD AT DESTINATION"},
    "N": {"es": "CARGA EN PROCESO DE ADUANA", "en": "CUSTOMS IN PROGRESS"}
}
